...
@property (weak, nonatomic) IBOutlet UIButton *onTwitterBtnClick;

@property (weak, nonatomic) IBOutlet UIButton *onGoogleBtnClick;

@property (weak, nonatomic) IBOutlet UIButton *onFbBtnClick;
@property (weak, nonatomic) IBOutlet UIButton *onInstaBtnClick;
...
@property (weak, nonatomic) IBOutlet UIImageView *loginImageIcon;
...
//    [self.navigationController setNavigationBarHidden:YES];
    ...
    _loginImageIcon.layer.cornerRadius = 50;
    self.loginImageIcon.clipsToBounds = YES;
//    _onFbBtnClick.layer.cornerRadius = 20;
//    self.onFbBtnClick.clipsToBounds = YES;
//    _onGoogleBtnClick.layer.cornerRadius = 20;
//    self.onGoogleBtnClick.clipsToBounds = YES;
//    _onTwitterBtnClick.layer.cornerRadius = 20;
//    self.onTwitterBtnClick.clipsToBounds = YES;
//    _onInstaBtnClick.layer.cornerRadius = 20;
//    self.onInstaBtnClick.clipsToBounds = YES;
}
