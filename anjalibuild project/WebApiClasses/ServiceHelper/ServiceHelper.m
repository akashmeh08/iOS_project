...
// Create complete requst format in case of Methode GET
- (NSURL *)formattedURL:(NSMutableDictionary *)parameterDict apiName:(NSString *)name {
    
    NSMutableString *urlString = [NSMutableString stringWithFormat:@"%@%@", _SERVICE_BASE_URL,name];
    BOOL isFirst = YES;
...
- (NSURL *)requestURL:(NSMutableDictionary *)parameterDict apiName:(NSString *)name method:(Method)methodType {
    ...
    NSString *urlString = [NSString stringWithFormat:@"%@%@",_SERVICE_BASE_URL,name];
   // return urlString ;
