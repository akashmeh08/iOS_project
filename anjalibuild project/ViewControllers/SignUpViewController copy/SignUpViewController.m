...
-(void) customInit
{
    _signupImageView.layer.borderColor = [UIColor blackColor].CGColor;
...
- (BOOL)textField:(UITextField *)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString *)string
{
    ...
    {
        if(textField.tag == 201 || textField.tag ==200)
        {
...
- (IBAction)termAndPolicyAction:(id)sender {
    UIStoryboard* storyboard = [UIStoryboard storyboardWithName:@"Main" bundle:nil];
    TermsAndPolicyViewController * controller = [storyboard instantiateViewControllerWithIdentifier:@"termAndPolicy"];
