...
@interface PathMenuViewController ()<DCPathButtonDelegate>
...
{
    [super viewDidLoad];
    self.navigationItem.title = @"Path Menu";
...
- (void)configureDCPathButton
{
    ...
    dcPathButton.bloomAngel     = 360.0;
    dcPathButton.dcButtonCenter = CGPointMake(170 + dcPathButton.frame.size.width/2, self.view.frame.size.height - dcPathButton.frame.size.height/2 - 300);
