...
#ifndef Macro_h
#define Macro_h
#define MAX_PASSWORD                                      "Password must be atmost 16 characters."
...
/****************** Validation Alerts ****************************/
#define             SUCCESS_REGISTRATION                        "You have been successfully signed up."
#define             MIN_PASSWORD                                "Password must be atleast 6 characters."
#define             BLANK                          ""
#define             Max_PASSWORD                                 "Please enter maximum 16 characters password."
#define             BLANK_Email                                  "Please enter valid email id."
