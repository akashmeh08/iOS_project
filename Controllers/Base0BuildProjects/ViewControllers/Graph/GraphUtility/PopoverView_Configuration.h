...
#define kGradientBottomColor   [[OPThemeManager sharedManager] textContentSelectedColor]//[UIColor colorWithRed:0.f green:0.f blue:0.f alpha:0.7]

//top color white value in gradient bg
//#define kGradientTopColor [UIColor colorWithRed:1.f green:1.f blue:1.f alpha:kBoxAlpha]
#define kGradientTopColor  [[OPThemeManager sharedManager] textContentSelectedColor] //[UIColor colorWithRed:0.f green:0.f blue:0.f alpha:0.7]
...
//title text color
#define kTitleColor [UIColor redColor] // [UIColor colorWithRed:0.329 green:0.341 blue:0.353 alpha:1]
