...
#import "OPPopoverView.h"
#import <QuartzCore/QuartzCore.h>
#import "Macro.h"

#pragma mark - Implementation

@implementation OPPopoverView
...
+ (OPPopoverView *)showPopoverAtPoint:(CGPoint)point inView:(UIView *)view withText:(NSString *)text delegate:(id<PopoverViewDelegate>)delegate {
    OPPopoverView *popoverView = [[OPPopoverView alloc] initWithFrame:CGRectZero];
...
+ (OPPopoverView *)showPopoverAtPoint:(CGPoint)point inView:(UIView *)view withTitle:(NSString *)title withText:(NSString *)text delegate:(id<PopoverViewDelegate>)delegate {
    OPPopoverView *popoverView = [[OPPopoverView alloc] initWithFrame:CGRectZero];
...
+ (OPPopoverView *)showPopoverAtPoint:(CGPoint)point inView:(UIView *)view withViewArray:(NSArray *)viewArray delegate:(id<PopoverViewDelegate>)delegate {
    OPPopoverView *popoverView = [[OPPopoverView alloc] initWithFrame:CGRectZero];
...
+ (OPPopoverView *)showPopoverAtPoint:(CGPoint)point inView:(UIView *)view withTitle:(NSString *)title withViewArray:(NSArray *)viewArray delegate:(id<PopoverViewDelegate>)delegate {
    OPPopoverView *popoverView = [[OPPopoverView alloc] initWithFrame:CGRectZero];
...
+ (OPPopoverView *)showPopoverAtPoint:(CGPoint)point inView:(UIView *)view withStringArray:(NSArray *)stringArray delegate:(id<PopoverViewDelegate>)delegate {
    OPPopoverView *popoverView = [[OPPopoverView alloc] initWithFrame:CGRectZero];
...
+ (OPPopoverView *)showPopoverAtPoint:(CGPoint)point inView:(UIView *)view withTitle:(NSString *)title withStringArray:(NSArray *)stringArray delegate:(id<PopoverViewDelegate>)delegate {
    OPPopoverView *popoverView = [[OPPopoverView alloc] initWithFrame:CGRectZero];
...
+ (OPPopoverView *)showPopoverAtPoint:(CGPoint)point inView:(UIView *)view withStringArray:(NSArray *)stringArray withImageArray:(NSArray *)imageArray delegate:(id<PopoverViewDelegate>)delegate {
    OPPopoverView *popoverView = [[OPPopoverView alloc] initWithFrame:CGRectZero];
...
+ (OPPopoverView *)showPopoverAtPoint:(CGPoint)point inView:(UIView *)view withTitle:(NSString *)title withStringArray:(NSArray *)stringArray withImageArray:(NSArray *)imageArray delegate:(id<PopoverViewDelegate>)delegate {
    OPPopoverView *popoverView = [[OPPopoverView alloc] initWithFrame:CGRectZero];
...
+ (OPPopoverView *)showPopoverAtPoint:(CGPoint)point inView:(UIView *)view withTitle:(NSString *)title withContentView:(UIView *)cView delegate:(id<PopoverViewDelegate>)delegate {
    OPPopoverView *popoverView = [[OPPopoverView alloc] initWithFrame:CGRectZero];
...
+ (OPPopoverView *)showPopoverAtPoint:(CGPoint)point inView:(UIView *)view withContentView:(UIView *)cView delegate:(id<PopoverViewDelegate>)delegate {
    OPPopoverView *popoverView = [[OPPopoverView alloc] initWithFrame:CGRectZero];
...
+ (OPPopoverView *)showPopoverAtPoint:(CGPoint)point inView:(UIView *)view withContentView:(UIView *)cView backgroundCollor:(UIColor *)backgroundColor delegate:(id<PopoverViewDelegate>)delegate
{
    OPPopoverView *popoverView = [[OPPopoverView alloc] initWithFrame:CGRectZero];
     popoverView.bgColor = backgroundColor;
    [popoverView showAtPoint:point inView:view withContentView:cView];
    popoverView.delegate = delegate;
    [popoverView RELEASE];
    return popoverView;
...
- (void)showAtPoint:(CGPoint)point inView:(UIView *)view withText:(NSString *)text
{
   ...
   // CGSize textSize = [text sizeWithFont:font constrainedToSize:CGSizeMake(screenSize.width - kHorizontalMargin*4.f, 1000.f) lineBreakMode:UILineBreakModeWordWrap];
    ...
    CGRect textRect = [text boundingRectWithSize:CGSizeMake(screenSize.width - kHorizontalMargin*4.f, CGFLOAT_MAX)  options:(NSStringDrawingUsesLineFragmentOrigin|NSStringDrawingUsesFontLeading)attributes:@{NSFontAttributeName: font} context:nil];
    
    
    UILabel *textView = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, textRect.size.width, textRect.size.height)];
...
- (void)showAtPoint:(CGPoint)point inView:(UIView *)view withTitle:(NSString *)title withViewArray:(NSArray *)viewArray
{
    ...
    CGSize titleSize =[title sizeWithAttributes:@{NSFontAttributeName: kTitleFont}];// [title sizeWithFont:kTitleFont];
...
- (void)drawRect:(CGRect)rect
{
    ...
    //// Shadow Declarations
    UIColor* shadow = [UIColor colorWithWhite:1.0f alpha:kShadowAlpha];
...
//                               (id)kGradientBottomColor.CGColor, nil];
    ...
    if (!self.bgColor) {
        ...
        self.bgColor = kGradientTopColor;
    }
    
    NSArray* gradientColors = [NSArray arrayWithObjects:
                               (id)self.bgColor.CGColor,
                               (id)self.bgColor.CGColor, nil];
