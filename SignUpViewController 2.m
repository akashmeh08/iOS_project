...
-(void)makeWebApiForLogin{
        ...
        if([[result objectForKey:@_RESPONSE_CODE] integerValue] == _RESPONSE_SUCCESS_CODE)
    {
        ...
        SWRevealViewController * homeVC = [storyboard instantiateViewControllerWithIdentifier:@"HomeScreen"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell1.signupTextField.layer.sublayerTransform=CATransform3DMakeTranslation(6.0f, 1.0f, 1.0f);
    switch(indexPath.row)
    {
        ...
        case 1:
            ...
            return cell1;
        case 2:
            cell1.signupTextField.autocapitalizationType = UITextAutocapitalizationTypeNone;
...
- (IBAction)signUpBtnAction:(id)sender {
    ...
    NSLog(@"==%d",![mObj.userPassword isEqualToString:mObj.userConfirmPassword ]);
